...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $db_username = "ekhonnec_vakhandli_group";
    $db_password = "vakhandli_group";
    ...
    if ($result->num_rows > 0) {
      ...
      header("Location: pages/forms/newClient.php");
        exit;
      };

    // Invalid login, show error message
    echo '<script>
    alert("Username or password not correct, please enter correct details");
    </script>';
}
...
<head>
  ...
  <title>Vakhandli Group | Login</title>
  <!-- plugins:css -->
          ...
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              <div class="brand-logo">
                <img src="images/Eyomusa.png" alt="logo">
              </div>
              <h4>Welcome back!</h4>
              ...
              <form class="pt-3" method = "post">
                ...
                <div class="text-center mt-4 font-weight-light">
                  Don't have an account? <a href="pages/samples/register-2.html" class="text-primary">Create</a>
                </div>
              </form>
            </div>
          </div>
