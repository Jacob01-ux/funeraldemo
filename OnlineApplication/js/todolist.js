...
document.querySelector('#Benefits_btn').addEventListener('click', function(){
  ...
  if(document.getElementById("Product_Additonal_Benefits").value === ""){
    ...
    if(document.getElementById("product_add_ben").value == 1){
      $(document).ready(function(){
        $.ajax({
            url:'n4.php',
            type:'post',
            data:{Name_of_Benefits:$('#Name_of_Benefits').val(), 
...
var msg = "";
const display = document.getElementById('err_msg');
if(document.getElementById("de_Name").value === "" || document.getElementById("de_Surname").value === ""){
