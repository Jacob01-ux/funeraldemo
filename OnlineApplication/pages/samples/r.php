...
$db = new mysqli('localhost', 'ekhonnec_vakhandli_group', 'vakhandli_group', 'ekhonnec_vakhandli_group');
...
$conn1 = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        ...
        //now saving extended members
                //now saving 
              //  $save = $conn1->prepare("INSERT INTO groups (group_name, slogan, cellPhone_number) 
              //  VALUES (:BusName, :slogan, :contactno)");
$save->bindParam(':BusName', $BusName);
$save->bindParam(':slogan', $slogan);
$save->bindParam(':contactno', $contactno);
