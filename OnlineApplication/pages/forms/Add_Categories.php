...
<head>
  ...
  <title>Vakhandli Group | Add Categories</title>
  <!-- plugins:css -->
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="addCategories.php">
                    
                    
                      <div class="form-group">
                      <label for="names">Categories</label>
                      <input type="text" class="form-control" id="categoryName" name ="categoryName" placeholder="Add new category">
                    </div>
                    
                    
                     
                    <button type="submit" class="btn btn-primary mr-2" name="Save" value="Save">Submit</button>
