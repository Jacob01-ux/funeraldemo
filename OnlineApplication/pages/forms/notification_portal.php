...
<?php
if(!empty($_POST['save_Asset'])){
	$to = $_POST['suppName'];
	$message = $_POST['disComment'];
...
<head>
  ...
  <title>Vakhandli Group | notification portal</title>
  <!-- plugins:css -->
                ...
                <div class="card-body">
                 ...
                 <form class="pt-3" method="post" >
                   <div class="form-group">
                      <label for="exampleSelectGender">Choose</label>
                    ...
                    <div class="form-group">
                      <label for="exampleSelectGender">Type of client</label>
                        <select class="form-control" id="AYear" name="AYear" >
                         <option>All</option>
<option>Female clients</option>
<option>Male clients</option>
<option>Premiums paid</option>
<option>Premiums not paid</option>
                        </select>
                      </div>
                   
                    <div class="form-group">
                      <label for="exampleTextarea1">Type a message</label>
                      <textarea class="form-control" id="disComment1" name = "disComment1" placeholder ="Enter text" rows="6"></textarea> 
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="suppName" name="AsuppName" placeholder="Eg. example@mail.com">
                    </div>
                   
              
               
    <div style="text-align: center;">
        <button type="submit" class="btn btn-primary mr-2" name="save_Asset">Send Email</button>
...
<div class="col-md-6 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">SMS Notification</h4>
            <p class="card-description"></p>
            <form class="pt-3" method="post" action="send_sms.php">
                <div class="form-group">
                    <label for="exampleSelectGender">Choose</label>
                ...
                <div class="form-group">
                    <label for="exampleTextarea1">Type a message</label>
                    <textarea class="form-control" id="disComment" name="disComment" placeholder="Enter text" rows="6"></textarea>
                </div>
                <div class="form-group">
                    <label for="exampleInputUsername1">Phone Number</label>
                    <input type="text" class="form-control" id="DisprodName" name="DisprodName" placeholder="eg. 087654321">
                </div>
                <div style="text-align: center;">
                    <button type="submit" id='sub' class="btn btn-primary mr-2" name="save_Disposal">Send SMS</button>
                    <button type="reset" class="btn btn-light" onclick="clearTextbox()" name="resetDis">Clear All</button>
                    <button type="records" class="btn btn-light" onclick="window.location.href='AssetTable.php'" name="recordDis">Records</button>
                </div>
            </form>
        </div>
    </div>
