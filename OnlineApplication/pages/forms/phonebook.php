...
<head>
  ...
  <title>Vakhandli Group | Phonebook</title>
  <!-- plugins:css -->
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="Phonebook.php" Method="post">
                    <div class="form-group">
                      <label for="exampleInputName1">Name and Surname</label>
                      <input type="text" class="form-control" id="Name_and_Surname" placeholder="Enter Name and Surname" name="Name_and_Surname">
                    </div>    
                    <div class="form-group">
                      <label for="exampleInputEmail3">ID Number</label>
                      <input type="text" class="form-control" id="ID_" placeholder="Enter ID Number" name="ID_">
                    </div>
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <label for="exampleInputPassword4">Company Telephone</label>
                      <input type="text" class="form-control" id="Company_telephone" placeholder="Enter Telephone Number" name="Company_telephone">
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Physical Address</label>
                      <textarea class="form-control" id="Physical_Address" placeholder="Enter Physical Address" name="Physical_Address" rows="4"></textarea>
                    
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Email Address</label>
                      <input type="text" class="form-control" id="Email_Address" placeholder="Enter Email Address" name="Email_Address">
                    </div>
                     <div class="form-group">
                    <label for="exampleFormControlSelect1">User Title</label>
                   ...
                   <button type="submit" class="btn btn-primary mr-2" name="Save" value="Save phonebook">Submit</button>
                    <button type="reset" class="btn btn-light" value="Clear">Clear All</button>
                    <button type="button" class="btn btn-light" onclick="goToNextPage()" name="recordDis">View Records</button>
                     </div>
                    </form> 
                   <br><br>
