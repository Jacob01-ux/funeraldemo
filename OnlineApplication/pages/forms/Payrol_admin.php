...
<head>
  ...
  <title>Vakhandli Group | Payroll_admin</title>
  <!-- plugins:css -->
    ...
    xhttp.send();
        ...
        <div class="card-body" id="print-slip" style="display: none;">
            ...
            <div class="d-flex flex-row align-items-start justify-content-between w-100" style="padding-bottom: 0%; padding-left: 2%; padding-right: 2%;">
              <div>
              <label style="display: inline-block; font-weight: bolder; color: black; font-size: 50px; padding-bottom: 0%;">Vakhandli Group</label></br>
              <label style="display: inline-block; font-weight: bold; color: grey; font-size: smaller; padding-bottom: 0%;">1245 Tamarin Street,Blue Hills Ext 15,Midrand,1685</label></br>
              <label style="display: inline-block; font-weight: bold; color: grey; font-size: smaller; padding-bottom: 0%;"></label></br>
              <label style="display: inline-block; font-weight: bold; color: grey; font-size: smaller; padding: 0%; padding-bottom: 0%;">082 889 6943</label></br>
              <div>
