...
$date = $_POST['date'];
  ...
  $stmt = $conn->prepare("INSERT INTO stock (year, month, Date, Action, Product, PNumber, Qty, Unit_price) 
  VALUES (:year, :month, :date, :action, :product, :product_number,:Quantity, :price_per_product)");
