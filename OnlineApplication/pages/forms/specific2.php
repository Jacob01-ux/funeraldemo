...
<title>Funeral demo | Invoicepage</title>
...
$conn = new mysqli($host, $username, $password, $dbname);
  ...
  $query = mysqli_query($conn, "select * from clients where _ID='$_POST[data]'");
  $row = mysqli_fetch_array($query);
  $isthe = mysqli_num_rows($query);
  
  $querys = mysqli_query($conn, "select * from sales_payment where ID='$_POST[sales]'");
