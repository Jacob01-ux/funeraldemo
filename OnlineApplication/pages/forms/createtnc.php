...
<head>
  ...
  <title>Vakhandli Group | T and Cs</title>
  <!-- plugins:css -->
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="PolicyInfo" method="POST" action="tnc.php" >
                    ...
                    <div class="form-group">
                      <label for="tnc"><B>Terms and Conditions</B></label>
                      <textarea class="form-control" id="tnc" name = "tnc" rows="20" placeholder="Enter terms and conditions" required></textarea>
                    </div>
                      <br> <br>
                           	<script>
		function submitForm() {
