...
<head>
  ...
  <title>Vakhandli Group | Products</title>
  <!-- plugins:css -->
    ...
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" method="post" action="asset.php">
          <!-- page code goes here-->
<label for="exampleSelectGender">Business Name</label>
<input type="text" class="form-control" name="prodCategory" list="categoryOptions" placeholder="Select Business Name">
...
<div class="form-group">
    ...
    <div class="form-group ">
  <label for="exampleInputName1" >spouse Cover Amount</label>
    <input type="text" class="form-control" inputmode="numeric" pattern="^\$?[0-9]{1,3}(?:,?[0-9]{3})*(?:\.[0-9]{2})?$" id="spouseCoverAmnt" name="spouseCoverAmnt" placeholder="R0.00" step="0.01">
  </div>
<div >
  <div class="form-group ">
  <label for="exampleInputName1" >depended Cover Amount</label>
    <input type="text" class="form-control" inputmode="numeric" pattern="^\$?[0-9]{1,3}(?:,?[0-9]{3})*(?:\.[0-9]{2})?$" id="depCoverAmnt"name="depCoverAmnt" placeholder="R0.00" step="0.01">
  </div>
<div >
