...
<img class="img-responsive" alt="iamgurdeeposahan" src="download.png" style="width: 71px; border-radius: 43px;">
</div>
</div>
...
if (!empty($result4)) {
?>
<label style="display: block; font-weight: bold; color: grey">Spouse Information</label>
   <table class="table">
  ...
  <?php
                    foreach ($result4 as $rows) {
                        ?>
    <tr>
      <td><?php echo $rows['spouse_Name'] ?></td>
      <td><?php echo $rows['spouse_Surname'] ?></td>
      <td><?php echo $rows['spouse_ID']?></td>
      <td><?php echo $rows['spouse_Number'] ?></td>
    </tr>
    <?php
                    }
                    ?>
