...
<head>
  ...
  <title>Vakhandli Group | Premium</title>
  <!-- plugins:css -->
	...
	$(document).ready(function(){
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="PolicyInfo" method="POST" action="Premuim.php" >
                    <div class="form-group">
                     
                       <div class="form-group">
                         <label for="month">Month</label>
                         
                        <select class="form-control" id="month" name="month" placeholder="Enter month">
                         ...
                         <div id='result' style='background-color:lightgray; width:40%; '></div>
                      </div>
                    <div class="form-group">
                      <label for="year">Year</label>
                       <select class="form-control" id="year" name="year" required>
 						 <option disabled selected value="">Enter year</option>
 					 <?php
                      ...
                      <div id='result1' style='background-color:lightgray; width:40%; '></div>
                      </div>
                     ...
                     <div class="form-group">
                      <label for="product">Policy number </label>
                       <select class="form-control" id="PolicyNumber" name="PolicyNumber" onchange="myFunction()" >
                          <option value="">Select or Enter a Policy Number</option>
                       <?php
  
  						$query = mysqli_query($conn, 'select DISTINCT Policy from clients ');
                 ...
                 <!--  <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="PolicyNumber"  name="PolicyNumber" placeholder="AMA123" >
                      
                      <div id='result3a' style='background-color:lightgray; width:40%; '></div>
                    </div>
                    -->
                    <div class="form-group">
                      <label for="Name">Name and Surname</label>
                      <input type="text" class="form-control" id="Name_and_Surname" name="Name_and_Surname"  placeholder="Enter Name and Surname" >
                      
                      
                    </div>
                    
                    <div class="form-group">
                      <label for="ID/Passport">SA ID/Passport</label>
                      <input type="text" class="form-control" id="identity" name="ID" placeholder="Enter ID/Passport Number" >
                      <div id='result3' style='background-color:lightgray; width:40%; '></div>
                    </div>
                     <div class="form-group">
                      <label for="Name">Contact Number</label>
                      <input type="text" class="form-control" id="ContactNumber" name="ContactNumber"  placeholder="Enter Name and Surname" >
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Policy_Plan" name="Policy_Plan" placeholder="Gold"readonly >
                      <div id='result4' style='background-color:lightgray; width:40%; '></div>
                    </div>
                    
                     <div class="form-group">
                      <label for="Policy_Plan">Monthly Premium</label>
                      <input type="text" class="form-control" id="monthly_premium" name="monthly_premium" placeholder="Monthly Premium" >
                       <div id='result5' style='background-color:lightgray; width:40%; '></div>
                    </div>
                    
                    <div class="form-group">
                      <label for="date">Payment Date</label>
						<input type="date" class="form-control" id="pr_date" name="pr_date" placeholder="payment day">
                      <div id='result6' style='background-color:lightgray; width:40%; '></div>
                      <br> <br>
      ...
      function load_data2(query2)
		{
			...
			success:function(data)
			{
                ...
                $("input[name='Name_and_Surname']").val(data);
			}
			});
		}
      ...
      function load_data3(query3)
              ...
              function load_data4(query4)
		{
			...
			success:function(data)
			{
				 $("input[name='ContactNumber']").val(data);
			}
			});
		}
           function load_data5(query5)
		{
			...
			success:function(data)
			{
				 $("input[name='Policy_Plan']").val(data);
			}
			});
		}
               ...
               function load_data6(query6)
		{
			...
			success:function(data)
			{
				 $("input[name='monthly_premium']").val(data);
			}
			});
		}
		...
		function submitForm() {
			...
			xhr2.send(formData);
                    ...
                    <button type="submit" class="btn btn-primary" onclick="submitForm()" value="Submit">Submit</button>
 					...
 					<a href='Premuimview.php' ><button  type='button' class="btn btn-light" value="Records">View Records</button></a>
                    </div>
...
const output2 = document.getElementById('identity');
const output3 = document.getElementById('ContactNumber');
const output4 = document.getElementById('Policy_Plan');
const output5 = document.getElementById('monthly_premium');
const output6 = document.getElementById('pr_date');
  ...
  $.ajax({
    ...
    success: function(response) {
      ...
      if (response === 'No results found') {
        ...
        const [Client, Client_id, Plan, monthly_premium, Date] = response.split(',');
        output1.value = Client;
        output2.value = Client_id;
        output3.value = Plan;
        output4.value = monthly_premium;
        output5.value = Date;
      }
    },
    error: function() {
