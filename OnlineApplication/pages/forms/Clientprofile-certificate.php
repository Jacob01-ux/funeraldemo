...
$password = "vakhandli_group";
	...
	$sql2 = "SELECT * FROM spousedetails
	WHERE Policy = '$policy'";
	...
	$sql3 = "SELECT Policy FROM clients WHERE Policy ='$policy'";
...
<head>
<meta charset="utf-8">
<title>Vakhandli Group | Policy certicate</title>
...
<div>
	<label style="display: block; font-weight: bold; color: grey; text-align: center; text-align: center; padding:1%">POLICY-NUMBER: <?= htmlspecialchars($c["Policy"]) ?></label>
	...
	<tbody>
	  <tr>
		<td style="font-size: 10px">
          <h5 style="margin-bottom: 0em;  margin-top: 1em;"><b></b><?= htmlspecialchars($c["Customer"]) ?></h5>
			<p style="margin-bottom: -1.5em;  margin-top: 0em;"><b>Mobile :</b> <?= htmlspecialchars($c["Number"]) ?></p><br/>
			<p style="margin-bottom: -1.5em;  margin-top: 0em;"><b>ID :</b><?= htmlspecialchars($c["_ID"]) ?></p><br/> 
			<p style="margin-bottom: -1.5em;  margin-top: 0em;"><b>Email :</b><?= htmlspecialchars($c["email"]) ?></p><br/>
			<p style="margin-bottom: -1.5em;  margin-top: 0em;"><b>Address :</b><?= htmlspecialchars($c["Address"]) ?></p><br/> 
		</td>
