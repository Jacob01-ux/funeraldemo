...
$pdo = new PDO('mysql:host=localhost;dbname=ekhonnec_vakhandli_group', 'ekhonnec_vakhandli_group', 'vakhandli_group');
...
foreach ($headers as $key => $value) {
    ...
    echo '<input type="text" class="form-control" id="' . htmlspecialchars($key) . '" name="' . htmlspecialchars($key) . '" value="' . htmlspecialchars($row[$key]) . '">';
    echo '</div>';
}
?>
...
?>
        <div>
            <label for="<?php echo htmlspecialchars($header); ?>"><?php echo htmlspecialchars($header); ?>:</label>
            <br>
            <input type="text" class="form-control" id="<?php echo htmlspecialchars($header); ?>" name="<?php echo htmlspecialchars($header); ?>" value="<?php echo htmlspecialchars($product[$header]); ?>">
            <br>
        </div>
    <?php } ?>
