...
<head>
  ...
  <title>Vakhandli Group | Upload_Button</title>
  <!-- plugins:css -->
            ...
            <div class="col-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <?php
                    ...
                    $connection = mysqli_connect("localhost","ekhonnec_vakhandli_group","vakhandli_group");
				$db= mysqli_select_db($connection,"ekhonnec_vakhandli_group"); 
...
<?php
/*
    $connection = mysqli_connect("localhost","ekhonnec_Eyomusa_Funeral","websystems_10");
				$db= mysqli_select_db($connection,"ekhonnec_Eyomusa_Funeral"); 
