...
$dbname = "ekhonnec_vakhandli_group";
  ...
  $stmt = $conn->prepare("INSERT INTO sale (Product_Name, Quantity, Price, Total_cost, PolicyNumber, Name, Contact, Address, Description) VALUES (:Product_Name, :Quality, :Price, :Total_cost, :PolicyNumber, :Name, :Contact, :Address, :Description)");
