...
<head>
  ...
  <title>Moahi Funeral Services | New Client</title>
  <!-- plugins:css -->
...
<input type="hidden" id="extraAmount" name="extraAmount" >
                     ...
                     <div class="form-group">
                      ...
                      <label for="Dep_covered">Dependent Covered</label>
                        <div class="input-group">
                        <input type="text" class="form-control" id="Dep_covered" name="Dep_covered"placeholder="" > 
                           <div class="input-group-append">
     					 <button class="btn btn-primary" type="button" id="addButton1">Add</button>
    					</div>
 					 </div>
                    </div>
                  
<div class="form-group">
    <label for="NameSurname">Dependents</label>
...
<button class="btn btn-primary" type="button" id="view">Delete</button>
<br><br>

<div class="form-group">
    <label for="ext_members">Extended Members</label>
    <div class="input-group">
        <input type="text" class="form-control" id="ext_members" name="ext_members" placeholder="">
        <div class="input-group-append">
            <button class="btn btn-primary" type="button" id="addButton2">Add</button>
        </div>
    </div>
</div>

<div class="form-group">
    <label for="NameSurnameExtend">Extended Members</label>
    <select class="form-control" id="NameSurnameExtend" name="NameSurnameExtend" disabled>
        <option value="">Select Name</option>
    ...
    function fetchDependents() {
        ...
        if (selectedPolicyNumber !== '') {
            $.ajax({
                ...
                data: { policyNumber: selectedPolicyNumber },
                success: function(response) {
...
<button class="btn btn-primary" type="button" id="view1">Delete</button>
                  <br><br>
<script>
    document.getElementById("view1").addEventListener("click", function() {
        ...
        document.getElementById("myForm").submit(); // Submit the form
                   ...
                   <div class="form-group">
                      <label for="Preferred_Payment_Date">Preferred Payment Day</label>
                        <input type="text" class="form-control" id="Preferred_Payment_Date" name="Preferred_Payment_Date" placeholder="" required>
                  ...
                  <h4 class="card-title"><b>Main Member</b></h4>
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="idno" name="idno" placeholder="" required>
                    </div>
                    <div class="form-group ">
                      ...
                      <input type="text"class="form-control" id="languages_" name="languages_" placeholder=""required>
                    ...
                    <div class="form-group">
                     ...
                     <input type="text"class="form-control" id="res_address" name= "res_address" rows="4" placeholder=""required>
                    </div>
                    <div class="form-group">
                      <label for="m_status">Marital Status</label>
                        <input type="text"class="form-control" id="m_status" name="m_status"  placeholder=""required>
                  ...
                  <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Sp_Surname" name="Sp_Surname" placeholder="">
                    </div>
                    
                     <div class="form-group">
                      <label for="ContactNo">Spouse Contact number</label>
                      <input type="number" class="form-control" id="Sp_ContactNo" name="Sp_ContactNo" placeholder="">
                    </div>
                   
                    <div class="form-group">
                      <label for="idNumber">Spouse ID/passport</label>
                      <input type="number" class="form-control" id="Sp_idNumber" name="Sp_idNumber" placeholder="">
                    </div>
                       
                  
                   <h4 class="card-title"><b>Payment History</b></h4>
		...
		<div class="form-group">
			...
			<div class="form-group">
                      <label for="Premium">Premium</label>
                      <input type="text" class="form-control" id="Premium1" name="Premium1" placeholder="">
                    </div>
		...
		<div class="form-group">
                  ...
                  <button type="update" name="update" id="update"  class="btn btn-primary mr-2">Update</button>
 				  <button type="delete" name="delete" id="delete"  class="btn btn-light">Delete</button>
...
<script>            
  ...
  $.ajax({
    ...
    error: function() {
      console.log('Error sending value to the server.');
      ...
      function load_databeneficiaries(querybeneficiaries)
			...
			url:"profiledata.php",
			method:"POST",
			data:{querybeneficiaries:querybeneficiaries},
			success:function(data)
			{
...
<script>
  ...
  addButton1.addEventListener('click', function() {
    ...
    window.location.href = 'Extended.php';
  });
