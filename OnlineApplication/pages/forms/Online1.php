...
$admin_id = "MFS" . str_pad($ad_id, 3, '0', STR_PAD_LEFT);
...
try {
  ...
  $stmt = $conn->prepare("INSERT INTO incoming_clients (Customer, _ID, Number, Gender, Nationality, languageOf_com, Package, PremiumCoverAmount, Policy, Covered, Group_Name, email, Address, Product_Added_Benefit, extended_members, Marital_Status, Inception_date, Payment_Date, Period, _By) 
...
$massage = "Hello, $Customer\n\nYour application for $product has been successfully filled. Your application will be finalised within 24 hours. For Enquiries: \n\nKatleho | Katleho.co.za | 0678293770";
...
$business_o_massage = "Hello,\n\nYou have new incoming client, Averal You have a Total of 5 pending client Login to admin portal to approve/reject applications.  \n\nKatleho | auto response";
...
if ($status === '200') {
  ...
  header("Location: policy-certificate_incoming_Client.php");
?>