...
if ($result3) {
	...
	$sql4 = "SELECT * FROM incoming_spousedetails WHERE Policy = ?";
...
<head>
<meta charset="utf-8">
<title>Funeral Demo | Application Policy Qoute</title>
...
<img class="img-responsive" alt="eKhonnector" src="../../images/faces/face5.jpg" style="width: 91px; border-radius: 43px;">
</div>
</div>
...
<div>
	<br><br><br><label style="display: block; font-weight: bold; color: grey; text-align: center; text-align: center; padding:1%">APPLICATION-NUMBER: <?= htmlspecialchars($c["Policy"]) ?></label>
...
<br/>
<!--additiona, extended product -->
   <table class="table" style="margin-bottom: -1.5em;  margin-top: 0em;">
  <thead class="thead-light" style="background-color: white;">
    <tr>
      <th scope="col" style="color:grey">Dependent Members</th>
      <th scope="col" style="color:grey">Extended Members</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
<h6 style="color: rgb(140, 140, 140);"><b>Please note: </b>We will contact you within 24-48 hours to finalise your application</h6>
</div>
</div>
...
<div class="mt-3 text-center">
   <button type="button" id="downloadcerticate"  onclick="returnHome()" class="btn btn-primary mr-2">Return to Home</button>
  <button type="button" id="printcerticate" onclick="printcerticate()" class="btn btn-primary mr-2">Print Quote</button>
  <button type="button" id="downloadcerticate"  onclick="down()" class="btn btn-primary mr-2">Download</button><br><br><br><br>
</div>
</div>

<script>
function returnHome() {
    window.location.href = "http://www.eKhonnectorsystems.com";
}
</script>
...
docPDF.html(elementHTML, {
 ...
 windowWidth: 650
  ...
  alert("Press Ctrl and P to print");
</script>
</body>
</html>