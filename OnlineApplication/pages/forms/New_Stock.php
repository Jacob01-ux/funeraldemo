...
<head>
  ...
  <title>Vakhandli Group | New_Stock</title>
  <!-- plugins:css -->
        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">New Stock</li>
                </ol>
            </nav>
          </div>
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Physical Products / Services Rendered</h4>
                  <p class="card-description">
                    Fill In The Details Below
                  </p>
                  <form class="forms-sample" action="insert_stock.php" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="price_per_product" name="price_per_product" placeholder="Enter Selling Price Per Product">
                    </div>
                    <div class="form-group ">
...
// Function to check if a product code already exists in the database
function codeExists($pdo, $code)
{
  $sql = "SELECT COUNT(*) AS count FROM stock WHERE PNumber = :code";
...
function generateProductCode($pdo)
{
  ...
  $sql = "SELECT MAX(PNumber) AS max_code FROM stock";
  $stmt = $pdo->prepare($sql);
  $stmt->execute();
  ...
  if (!$row) {
    ...
    echo "Error retrieving item code.";
    return null;
  }
  ...
  // Find the next available product code
  $next_product_code = 'ITEM' . str_pad($next_numeric_part, 4, '0', STR_PAD_LEFT);
  while (codeExists($pdo, $next_product_code)) {
    $next_numeric_part++;
    $next_product_code = 'ITEM' . str_pad($next_numeric_part, 4, '0', STR_PAD_LEFT);
  }
...
// Generate the product code on page load
$next_product_code = generateProductCode($pdo);
?>
<input type="text" id="product_number" name="product_number" class="form-control" value="<?php echo $next_product_code; ?>" readonly>
                    ...
                    <a href="viewstocks.php"> <button type='button' class="btn btn-light">View Records</button></a>
