...
//LINE 9 TO LINE 20 REFRESHES THE NEW CLIENT PAGE AFTER 3 MINUTES - 
//This is so that the system does not show same policy number if you clict back from the policy certificate 
//--Refresh code ends here
session_start();
if (isset($_SESSION['visited']) && $_SESSION['visited']) {
    // Refresh the page or perform any desired actions
    header("Refresh: 180");
  echo "This application form refreshes every 2 minutes";
}
//--Refresh code ends here
...
function addDays($days) {
 /* $date = new DateTime(); // Get today's date
  $date->modify("+$days days"); // Add the specified number of days
...
<head>
  ...
  <title> Jeudfra Burial Society Service | Online Application</title>
  <!-- plugins:css -->
       ...
       <div class="main-panel">        
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <h3 class="page-title">
              Jeudfra Burial Society | New Policy Online Application
            </h3>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-description">
                    ...
                    <div class="form-group">
                      <label for="product">Product / Policy Name<a style="color: red; font-size: large;">*</a></label>
                     ...
                     <input type="hidden" id="policy_no" name="policy_no">
                      <div class="form-group-group">
                          <label for="policy_opt">Application number option<a style="color: red; font-size: large;">*</a></label>
                      ...
                      <div class="form-group">
                          <label for="policy_no1">Application Number<a style="color: red; font-size: large;">*</a></label>
                    ...
                    <input type="hidden" id="admin" name="admin" value="Client"/>
  ...
  datePicker.addEventListener("input", function() {
    ...
    if (day > 10) {
      ...
      this.value = selectedDate.toISOString().split("T")[0];
                    ...
                    <div class="form-group">
                          <label for="Preferred_Payment_Date">Application Date<a style="color: red; font-size: large;">*</a></label>
                ...
                <div class="card-body">
                  ...
                  <!-- <form class="forms-sample" method="post" action="n4.php"> -->
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <label for="date">Application date<a style="color: red; font-size: large;">*</a></label>
...
document.querySelector('#policy_opt').addEventListener('change', function() {
    document.getElementById("ac_dae").value = document.getElementById("act_date").value;
