                  ...
                  <option value="cheque">Cheque</option>
                    ...
                    <div class="form-group">
                     ...
                     <!-- <input type="text" class="form-control" id="act_date" name="act_date" placeholder="Activation Date will display here" required>-->
                       <input type="text" class="form-control" id="act_date"  name="act_date" value="<?php echo $newDate; ?>" placeholder="Policy Activation date will display here(today + 6months)" disabled required>
