...
<head>
  ...
  <title>Funeral Demo Service | Asset Register</title>
  <!-- plugins:css -->
...
<option>1999</option>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name = "Adatetime" data-inputmask="'alias': 'date'" />
                      </div>
...
<option>1999</option>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="DisReason" name = "DisReason" rows="2"></textarea>
                    </div>
                    <div class="form-group">
