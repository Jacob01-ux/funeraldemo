...
<body>
  ...
  <input type="text" class="form-control" id="searchPolicy" placeholder="Search Policy Number" oninput="filterOptions()">
...
<script>
  function filterOptions() {
    ...
    input = document.getElementById("searchPolicy");
    filter = input.value.toUpperCase();
    select = document.getElementById("PolicyNumber");
  ...
  <script>
    $(document).ready(function() {
      $('#PolicyNumber').change(function() {
        ...
        $.ajax({
          url: 'retrieve_records.php', // Replace with the correct path
          type: 'POST',
          data: { PolicyNumber: selectedPolicyNumber }, // Updated key name
