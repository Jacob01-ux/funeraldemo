...
<head>
  ...
  <title>Funeral Demo | Claims</title>
  <!-- plugins:css -->
...
<body>
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Claimer's Personal Information</h4>
                 ...
                 <form class="pt-3" method="post" action="asset.php">
                      ...
                      <label for="exampleInputUsername1">Identity Number</label>
                      <input type="text" class="form-control" id="Claimer_IDs" name="Claimer_IDs" placeholder="Enter ID number">
                    </div>
                    <div class="form-group">
                        <label>Date of Birth:</label>
                        <input class="form-control" name = "claimerDoD" id = "claimerDoD" data-inputmask="'alias': 'date'" />
                      </div>
    
                    <div class="form-group">
                      <label for="exampleInputUsername1">Name</label>
                      <input type="text" class="form-control" id="Claimer_name" name="Claimer_name" placeholder="Enter Name">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Surname</label>
                      <input type="text"  class="form-control" id="Claimer_name1" name="Claimer_name1" placeholder="Enter Surname">
                    </div>
                    <div class="form-group">
                    <label for="exampleFormControlSelect1">Gender</label>
                    <select class="form-control form-control-lg" id="Claimer_Genders" name="Claimer_Genders">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text"  class="form-control" id="Claimer_contacts" name="Claimer_contacts" placeholder="Enter Contact Number e.g 01234567891">
                    </div>
                    
                    <div class="form-group">
                      <label for="exampleInputConfirmPassword1">Area</label>
                      <input type="text"  class="form-control" id="Claimer_Areas" name="Claimer_Areas" placeholder="Enter Area">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Address</label>
                      <textarea type="text" class="form-control" id="Claimer_Addresss" name="Claimer_Addresss" placeholder="Enter Address"></textarea>
                    </div>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Claim Information</h4>
                  <p class="card-description">
                  ...
                  <form class="pt-3" method="post" action="asset.php">
                   <div class="form-group">
                        ...
                        <input class="form-control" name = "Claim_dates" id = "Claim_dates" data-inputmask="'alias': 'date'" />
                      </div>
                    
                    <div class="form-group">
                      <label for="exampleInputUsername1">Deceased ID</label>
                      <input type="text" class="form-control" id="D_id" name="D_id" placeholder="Enter Deceased ID">
                    </div>
                     <div class="form-group">
                      <label for="exampleInputEmail1">Deceased Name</label>
                      <input type="text" class="form-control" id="deasedName" name = "deasedName" placeholder="Enter Deceased Name">
                    </div>
                    <div class="form-group">

                      <label for="exampleInputEmail1">Deceased Surname</label>

                      <input type="text" class="form-control" id="deasedSurname" name = "deasedSurname" placeholder="Enter Deceased Surname">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name = "disPeriod" id = "disPeriod" data-inputmask="'alias': 'date'" />
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name = "ClaimerPeriod" id = "ClaimerPeriod" data-inputmask="'alias': 'date'" />

                      </div>
                    <div class="form-group">

                      <label for="exampleInputEmail1">Death Certificate Number</label>

                      <input type="text" class="form-control" id="death_certificate" name = "death_certificate" placeholder="Enter Death Certificate Number eg. pcF1223">
 ...
 <form>
    <div style="text-align: center;">
        <button  type="submit" id='sub' class="btn btn-primary mr-2" name="save_claims" >Submit</button>
...
function goToNextPage() {
  ...
  window.location.href = "AssetTable.php";
      ...
      function clearTextboxes() {
        document.getElementById("ClaimerPeriod").value = "";
  		document.getElementById("Claimer_name").value = "";
  		document.getElementById("Claimer_IDs").value = "";
  		document.getElementById("Claimer_contacts").value = "";
  		document.getElementById("Claimer_Genders").value = "";
  		document.getElementById("Claimer_Areas").value = "";
	    document.getElementById("Claimer_Addresss").value = "";
  		document.getElementById("Claim_dates").value = "";
  		document.getElementById("claimerDoD").value = "";
		document.getElementById("death_certificate").value = "";
  		document.getElementById("deasedSurname").value = "";
