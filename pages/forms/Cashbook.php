...
<head>
  ...
  <title>Funeral Demo Service | Cash Book</title>
  <!-- plugins:css -->
...
<option>1999</option>
                   ...
                   <div class="form-group">
                    ...
                    <label for="exampleFormControlSelect1">Description</label>
                       ...
                       <input type="text" class="form-control" id="cashDescription" name="cashDescription" placeholder="Enter Description">
                  </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="prodAmnt">product Amount</label>
                      <input type="text"  class="form-control" id="prodAmnt" name="prodAmnt" placeholder="">
                    </div>
                   <div class="form-group">
...
<option>1999</option>
                    ...
                    <div class="form-group">
                         <label for="month">Transaction method</label>
                        <select class="form-control" id="TransM" name="TransM">
                           <option>Select Transaction Method</option>
                          <option>Cash</option>
                           <option>Credit</option>
                          <option>Other</option>
