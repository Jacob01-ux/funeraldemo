...
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\RowCellIterator;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Writer\Exception;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Writer\Ods;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Writer\Ods\Cell\Comment;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Writer\Ods\Cell\Style;
...
//                $objWriter->writeAttribute('table:number-columns-repeated', self::NUMBER_COLS_REPEATED_MAX);
    ...
    private function writeCells(XMLWriter $objWriter, RowCellIterator $cells): void
    {
        ...
        foreach ($cells as $cell) {
            /** @var \PhpSpreadsheetmaster\src\PhpSpreadsheet\Cell\Cell $cell */
