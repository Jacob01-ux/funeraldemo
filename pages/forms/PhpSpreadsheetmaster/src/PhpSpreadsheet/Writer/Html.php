...
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Document\Properties;
...
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Shared\Drawing as SharedDrawing;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Shared\File;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Shared\Font as SharedFont;
...
class Html extends BaseWriter
{
     ...
     *
     * @param Worksheet $worksheet \PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet
    ...
    private function generateRowWriteCell(string &$html, Worksheet $worksheet, string $coordinate, string $cellType, string $cellData, int $colSpan, int $rowSpan, $cssClass, int $colNum, int $sheetIndex, int $row): void
    {
        ...
        if (!$this->useInlineCss && !$this->isPdf && is_string($cssClass)) {
            ...
            //** Necessary redundant code for the sake of \PhpSpreadsheetmaster\src\PhpSpreadsheet\Writer\Pdf **
