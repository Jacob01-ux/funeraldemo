...
class Workbook extends BIFFwriter
{
     ...
     * XF Writers.
     *
     * @var \PhpSpreadsheetmaster\src\PhpSpreadsheet\Writer\Xls\Xf[]
     */
    private $xfWriters = [];
     ...
     */
    public function addFont(\PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Font $font)
    {
     ...
     */
    private function writeBoundSheet(\PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet $sheet, $offset): void
    {
        ...
        switch ($sheet->getSheetState()) {
            case \PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VISIBLE:
                $ss = 0x00;

                break;
            case \PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_HIDDEN:
                $ss = 0x01;

                break;
            case \PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN:
                $ss = 0x02;
