...
namespace PhpSpreadsheetmaster\src\PhpSpreadsheet\Writer\Xls;

use GdImage;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Cell\Cell;
...
use PhpSpreadsheetmaster\src\PhpSpreadsheet\RichText\Run;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Shared\StringHelper;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Shared\Xls;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Border;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Color;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Conditional;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Protection;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\PageSetup;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\SheetView;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Writer\Exception as WriterException;
...
class Worksheet extends BIFFwriter
{
     ...
     * Formula parser.
     *
     * @var \PhpSpreadsheetmaster\src\PhpSpreadsheet\Writer\Xls\Parser
     */
    private $parser;
     ...
     * Sheet object.
     *
     * @var \PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet
     */
    public $phpSheet;
     ...
     *
     * @var null|\PhpSpreadsheetmaster\src\PhpSpreadsheet\Shared\Escher
     */
    private $escher;
     ...
     * @param \PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet $phpSheet The worksheet to write
     */
    public function __construct(&$str_total, &$str_unique, &$str_table, &$colors, Parser $parser, $preCalculateFormulas, \PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet $phpSheet)
    {
     ...
     *
     * @see \PhpSpreadsheetmaster\src\PhpSpreadsheet\Writer\Xls\Workbook::storeWorkbook()
     */
    public function close(): void
    {
        ...
        if (($defaultWidth = $phpSheet->getDefaultColumnDimension()->getWidth()) < 0) {
            $defaultWidth = \PhpSpreadsheetmaster\src\PhpSpreadsheet\Shared\Font::getDefaultColumnWidthByFont($phpSheet->getParentOrThrow()->getDefaultStyle()->getFont());
        }
     ...
     * Get Escher object.
     */
    public function getEscher(): ?\PhpSpreadsheetmaster\src\PhpSpreadsheet\Shared\Escher
    {
        return $this->escher;
    }
     ...
     * Set Escher object.
     */
    public function setEscher(?\PhpSpreadsheetmaster\src\PhpSpreadsheet\Shared\Escher $escher): void
    {
        $this->escher = $escher;
    }
    ...
    private function writeCFRule(
        ...
        if ($bFormatFont == 1) {
            ...
            switch ($conditional->getStyle()->getFont()->getUnderline()) {
                case \PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Font::UNDERLINE_NONE:
                    $dataBlockFont .= pack('C', 0x00);
                    $fontUnderline = 0;

                    break;
                case \PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Font::UNDERLINE_DOUBLE:
                    $dataBlockFont .= pack('C', 0x02);
                    $fontUnderline = 0;

                    break;
                case \PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Font::UNDERLINE_DOUBLEACCOUNTING:
                    $dataBlockFont .= pack('C', 0x22);
                    $fontUnderline = 0;

                    break;
                case \PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLE:
                    $dataBlockFont .= pack('C', 0x01);
                    $fontUnderline = 0;

                    break;
                case \PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLEACCOUNTING:
