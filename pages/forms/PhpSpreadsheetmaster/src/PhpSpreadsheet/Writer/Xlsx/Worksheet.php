...
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalDataBar;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalFormattingRuleExtension;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\SheetView;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet as PhpspreadsheetWorksheet;
...
class Worksheet extends WriterPart
{
    ...
    private function writeDrawings(XMLWriter $objWriter, PhpspreadsheetWorksheet $worksheet, $includeCharts = false): void
    {
        ...
        if (isset($unparsedLoadedData['sheets'][$worksheet->getCodeName()]['drawingOriginalIds'])) {
            ...
            // (! synchronize with \PhpSpreadsheetmaster\src\PhpSpreadsheet\Writer\Xlsx\Rels::writeWorksheetRelationships)
