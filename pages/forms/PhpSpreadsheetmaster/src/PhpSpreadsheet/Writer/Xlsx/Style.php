...
class Style extends WriterPart
{
     ...
     * Write Cell Style Xf.
     */
    private function writeCellStyleXf(XMLWriter $objWriter, \PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Style $style, Spreadsheet $spreadsheet, string $defaultAlignHash): void
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', '0');
     ...
     */
    private function writeCellStyleDxf(XMLWriter $objWriter, \PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Style $style): void
    {
        // dxf
     ...
     *
     * @return \PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Style[] All styles in PhpSpreadsheet
     */
    ...
    public function allFills(Spreadsheet $spreadsheet)
    {
        ...
        /** @var \PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Style $style */
