...
class Comments extends WriterPart
{
     ...
     */
    public function writeComments(\PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet $worksheet)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @return string XML Output
     */
    public function writeVMLComments(\PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet $worksheet)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
