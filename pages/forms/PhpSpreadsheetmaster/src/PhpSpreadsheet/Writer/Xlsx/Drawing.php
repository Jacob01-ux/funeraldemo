...
class Drawing extends WriterPart
{
     ...
     */
    public function writeDrawings(\PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet $worksheet, $includeCharts = false)
    {
        // Create XML writer
        $objWriter = null;
     ...
     */
    public function writeChart(XMLWriter $objWriter, \PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\Chart $chart, $relationId = -1): void
    {
     ...
     * @return string XML Output
     */
    public function writeVMLHeaderFooterImages(\PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet $worksheet)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
