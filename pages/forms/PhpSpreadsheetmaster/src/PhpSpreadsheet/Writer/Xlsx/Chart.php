...
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\Properties;
...
class Chart extends WriterPart
{
     ...
     */
    public function writeChart(\PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\Chart $chart, $calculateCellValues = true)
    {
        // Create XML writer
        $objWriter = null;
