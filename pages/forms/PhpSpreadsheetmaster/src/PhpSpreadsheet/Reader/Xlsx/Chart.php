...
namespace PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx;

use PhpSpreadsheetmaster\src\PhpSpreadsheet\Calculation\Information\ExcelError;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\Axis;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\AxisText;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\ChartColor;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\DataSeries;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\DataSeriesValues;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\GridLines;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\Layout;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\Legend;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\PlotArea;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\Properties as ChartProperties;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\Title;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\TrendLine;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx;
...
class Chart
{
     ...
     *
     * @return \PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\Chart
     */
    public function readChart(SimpleXMLElement $chartElements, $chartName)
    {
        ...
        $chart = new \PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, (string) $dispBlanksAs, $XaxisLabel, $YaxisLabel, $xAxis, $yAxis);
        if ($chartNoFill) {
