...
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Helper\Dimension as CssDimension;
...
class Html extends BaseReader
{
        ...
        if (is_string($cellContent)) {
            ...
            if (trim($cellContent) > '') {
                ...
                if (isset($attributeArray['data-type'])) {
                    ...
                    } catch (\PhpSpreadsheetmaster\src\PhpSpreadsheet\Exception $exception) {
    ...
    public function getStyleColor($value)
    {
        ...
        return \PhpSpreadsheetmaster\src\PhpSpreadsheet\Helper\Html::colourNameLookup($value);
    }
