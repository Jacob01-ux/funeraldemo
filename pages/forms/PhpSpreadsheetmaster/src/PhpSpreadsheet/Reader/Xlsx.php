...
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Cell\DataType;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Cell\Hyperlink;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\DefinedName;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Security\XmlScanner;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx\AutoFilter;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx\Chart;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx\ColumnAndRowAttributes;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx\ConditionalStyles;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx\DataValidations;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx\Hyperlinks;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx\Namespaces;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx\PageSetup;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx\Properties as PropertyReader;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx\SharedFormula;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx\SheetViewOptions;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx\SheetViews;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx\Styles;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx\TableReader;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx\Theme;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Xlsx\WorkbookView;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\ReferenceHelper;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\RichText\RichText;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Settings;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Shared\Date;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Shared\Drawing;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Shared\File;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Shared\Font;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Shared\StringHelper;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Spreadsheet;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Color;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Font as StyleFont;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\NumberFormat;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Style;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\HeaderFooterDrawing;
...
class Xlsx extends BaseReader
{
                                        ...
                                        if (isset($shape['style'])) {
                                            ...
                                            if (($column !== null) && ($row !== null)) {
                                                ...
                                                if (isset($drowingImages[$fillImageRelId])) {
                                                    $objDrawing = new \PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Drawing();
                ...
                foreach ($is->r as $run) {
                    if (!isset($run->rPr)) {
                        ...
                        if (isset($run->rPr->u)) {
                            ...
                            if (!isset($attr['val'])) {
                                $objFont->setUnderline(\PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLE);
                            } else {
     ...
     */
    private function readHyperLinkDrawing(\PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Drawing $objDrawing, SimpleXMLElement $cellAnchor, $hyperlinks): void
    {
