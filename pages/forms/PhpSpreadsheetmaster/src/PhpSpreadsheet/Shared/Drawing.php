...
namespace PhpSpreadsheetmaster\src\PhpSpreadsheet\Shared;

use GdImage;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Reader\Exception as ReaderException;
...
class Drawing
{
     ...
     */
    public static function pixelsToCellDimension($pixelValue, \PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Font $defaultFont)
    {
        // Font name and size
     ...
     * @param \PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Font $defaultFont Default font of the workbook
     *
     * @return int Value in pixels
     */
    public static function cellDimensionToPixels($cellWidth, \PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Font $defaultFont)
    {
        // Font name and size
        $name = $defaultFont->getName();
        $size = $defaultFont->getSize();
