...
namespace PhpSpreadsheetmaster\src\PhpSpreadsheet\Cell;
...
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Shared\Date as SharedDate;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Shared\StringHelper;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\ConditionalFormatting\CellStyleAssessor;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\NumberFormat;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Style\Style;
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Table;
    ...
    public static function setCalculateDateTimeType(int $calculateDateTimeType): void
    {
        switch ($calculateDateTimeType) {
            ...
            case self::CALCULATE_TIME_FLOAT:
                ...
                break;
            default:
                throw new \PhpSpreadsheetmaster\src\PhpSpreadsheet\Calculation\Exception("Invalid value $calculateDateTimeType for calculated date time type");
        }
    }
    ...
    public function getCalculatedValue(bool $resetLog = true)
    {
        if ($this->dataType === DataType::TYPE_FORMULA) {
            try {
                ...
                throw new \PhpSpreadsheetmaster\src\PhpSpreadsheet\Calculation\Exception(
