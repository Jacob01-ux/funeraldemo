...
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Calculation\Internal\WildcardMatch;
...
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule;
    ...
    public function __clone()
    {
        ...
        foreach ($vars as $key => $value) {
            if (is_object($value)) {
                ...
                //    The columns array of \PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet\AutoFilter objects
                $this->{$key} = [];
