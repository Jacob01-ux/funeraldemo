...
class BaseDrawing implements IComparable
{
    ...
    public function setWorksheet(?Worksheet $worksheet = null, bool $overrideOld = false): self
    {
        if ($this->worksheet === null) {
            // Add drawing to \PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet
            if ($worksheet !== null) {
            ...
            if ($overrideOld) {
                // Remove drawing from old \PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet
                ...
                // Set new \PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet
