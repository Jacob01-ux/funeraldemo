...
use PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Table\TableStyle;
    ...
    public function __clone()
    {
        ...
        foreach ($vars as $key => $value) {
            if (is_object($value)) {
                ...
                //    The columns array of \PhpSpreadsheetmaster\src\PhpSpreadsheet\Worksheet\Worksheet\Table objects
                $this->{$key} = [];
