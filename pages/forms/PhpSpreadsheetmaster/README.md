...
$className = \PhpSpreadsheetmaster\src\PhpSpreadsheet\Writer\Pdf\Dompdf::class;
...
Settings::setChartRenderer(\PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\Renderer\JpGraph::class);
//or
// to use mitoteam/jpgraph
Settings::setChartRenderer(\PhpSpreadsheetmaster\src\PhpSpreadsheet\Chart\Renderer\MtJpGraphRenderer::class);
```
