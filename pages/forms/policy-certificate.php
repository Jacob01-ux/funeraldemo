...
$sql3 = "SELECT Policy FROM clients WHERE Policy = :my_viriable";
...
<img class="img-responsive" alt="iamgurdeeposahan" src="favicon.png" style="width: 91px; border-radius: 43px;">
</div>
</div>
