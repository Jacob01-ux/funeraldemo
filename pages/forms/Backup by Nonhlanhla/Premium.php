...
//const output = document.getElementById('Name_and_Surname');
const output = document.getElementById('identity');
const output = document.getElementById('Policy_Plan');
const output = document.getElementById('monthly_premium');
const output = document.getElementById('pr_date');
*/
