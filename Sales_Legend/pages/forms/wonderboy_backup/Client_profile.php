                  ...
                  <h4 class="card-title"><b>Main Member</b></h4>
                    ...
                    <div class="form-group ">
                        <label class="col-sm-3 col-form-label">Nationality</label>
                          ...
                          <input type="text" class="form-control" id="main_Nationality" name="Nationality" required>
                    ...
                    <div class="form-group">
                     ...
                     <input type="text"class="form-control" id="res_address" name= "res_address"placeholder="Enter Address" rows="4" required>
                    </div>
                    <div class="form-group">
...
<div class="text-Left">
  <button type=""  class="btn btn-primary mr-2">UPDATE</button>
   <button type=""  class="btn btn-light">DELETE</button>
   <button type=""  class="btn btn-light">PRINT</button>
  <!--
