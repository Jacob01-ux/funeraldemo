...
<head>
  ...
  <title>Jeudfra_Burial_Society | Pending Applications</title>
  <!-- plugins:css -->
                    ...
                    <p class="card-description">
                      ...
                      <div class="col-md-12">
                       ...
                       <?php
  						...
  						$query = mysqli_query($conn, 'select * from incoming_clients');
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <!-- <div id="ad_member_ad" name="ad_member_ad"></div> -->
                   <button type="button" class="btn btn-primary mr-2" onclick="redirectToAcceptPage()" id="Accept_ap" name="Accept_ap">Accept</button>
                    <button type="button" id="Reject_ap" name="Reject_ap" onclick="redirectToRejectPage()" class="btn btn-light">Reject</button>
...
<script>
function redirectToAcceptPage() {
  var selectedPolicyNumber = document.getElementById("PolicyNumber").value;
  if (selectedPolicyNumber !== "") {
    // Get the form and its data
    var form = document.forms["policyForm"];

    // Get the values of the specified elements
    var adminValue = document.getElementById("admin").value;
    var nMonthValue = document.getElementById("n_month").value;
    var groupNameValue = document.getElementById("Group_Name").value;
    var productValue = document.getElementById("product").value;
    var premiumValue = document.getElementById("Premium").value;
    var productAddBenValue = document.getElementById("product_add_ben").value;
    var depCoveredValue = document.getElementById("Dep_covered").value;
    var extMembersValue = document.getElementById("ext_members").value;
    var preferredPaymentDateValue = document.getElementById("Preferred_Payment_Date").value;
    var inceptionDateValue = document.getElementById("inc_date").value;
    var namesValue = document.getElementById("names").value;
    ...
    var languagesValue = document.getElementById("languages_").value;
    var genderValue = document.getElementById("gender").value;
    var emailValue = document.getElementById("email").value;
    var resAddressValue = document.getElementById("res_address").value;
    var maritalStatusValue = document.getElementById("m_status").value;

    // Create a query string with the required data
    var queryString =
      "PolicyNumber=" + encodeURIComponent(selectedPolicyNumber) +
      "&admin=" + encodeURIComponent(adminValue) +
      "&n_month=" + encodeURIComponent(nMonthValue) +
      "&Group_Name=" + encodeURIComponent(groupNameValue) +
      "&product=" + encodeURIComponent(productValue) +
      "&Premium=" + encodeURIComponent(premiumValue) +
      "&product_add_ben=" + encodeURIComponent(productAddBenValue) +
      "&Dep_covered=" + encodeURIComponent(depCoveredValue) +
      "&ext_members=" + encodeURIComponent(extMembersValue) +
      "&Preferred_Payment_Date=" + encodeURIComponent(preferredPaymentDateValue) +
      "&inc_date=" + encodeURIComponent(inceptionDateValue) +
      "&names=" + encodeURIComponent(namesValue) +
      "&phone1=" + encodeURIComponent(phone1Value) +
      "&idno=" + encodeURIComponent(idNoValue) +
      "&Nationality=" + encodeURIComponent(nationalityValue) +
      "&languages_=" + encodeURIComponent(languagesValue) +
      "&gender=" + encodeURIComponent(genderValue) +
      "&email=" + encodeURIComponent(emailValue) +
      "&res_address=" + encodeURIComponent(resAddressValue) +
      "&m_status=" + encodeURIComponent(maritalStatusValue);

    // Navigate to accept.php with the data as query parameters
    window.location.href = 'accept.php?' + queryString;
  }
}
</script>
<script>
function redirectToRejectPage() {
  var selectedPolicyNumber = document.getElementById("PolicyNumber").value;
  if (selectedPolicyNumber !== "") {
    // Get the form and its data
    var form = document.forms["policyForm"];
    ...
    // Navigate to accept.php with the data as query parameters
    window.location.href = 'reject.php?' + queryString;
  }
}
</script>
