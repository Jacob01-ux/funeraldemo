...
<head>
  ...
  <title>Funeral Demo | Approved Applications</title>
  <!-- plugins:css -->
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"><a class="nav-link" href="Incoming-clients.php">Pending Applications</a></li>
                <li class="nav-item"><a class="nav-link" href="Incoming-rejected.php">Rejected Applications</a></li>
                 <li class="nav-item"><a class="nav-link" href="Incoming-approved.php">Approved Applications</a></li>
                <li class="nav-item"><a class="nav-link" href="Incoming-reports.php">Reports</a></li>
              </ul>
            </div>
          </li>
          <!--<li class="nav-item">
                    ...
                    <p class="card-description">
                      ...
                      <div class="col-md-12">
                       ...
                       <?php
                        ...
                        $query = mysqli_query($conn, 'SELECT * FROM incoming_approved WHERE _By = "' . htmlspecialchars($u["names"]) . '"');
