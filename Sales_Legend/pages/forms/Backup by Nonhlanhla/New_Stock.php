...
<head>
  ...
  <title>Funeral Demo | New_Stock</title>
  <!-- plugins:css -->
        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Physical Products / Mechandise</h4>
                  ...
                  <form class="forms-sample" action="insert_stock.php" method="post">
                    ...
                    <div class="form-group">
                      <label for="exampleSelectGender">Product</label>
                        <select class="form-control" id="product" name="product">
                          ...
                          <option value="cofin">Cofin</option>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Manufacturing" name="Manufacturing" placeholder="Enter Manufacturing / Cost Price">
                    </div>    
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="product_number" name="product_number" placeholder="Enter Product Number">
                    </div>
