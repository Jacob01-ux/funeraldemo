...
<head>
  ...
  <title>Funeral Demo | Cash Book</title>
  <!-- plugins:css -->
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                 ...
                 <form class="pt-3" method="post" action="cashbook.php">
...
<option>1999</option>
                   ...
                   <div class="form-group-group">
                        	<label for="PolicyNumber">Types of Transaction</label>
                        
                		    <label style="padding-left: 20px;" for="policy_opt1">Automatic</label>
							<input type="radio" id="transactionType" name="transactionType" value="1">
                      
								<label style="padding-left: 20px;" for="policy_opt">Manually</label>
								<input type="radio" id="transactionType" name="transactionType" value="2">
                    </div>
                   <br>
                        <div class="form-group">
                      <label for="exampleInputUsername1">From</label>
                      <input type="text" class="form-control" id="from" name="from" placeholder="AMA123">
                    </div>
    
                    <div class="form-group">
                      <label for="exampleInputUsername1">Reference</label>
                      <input type="text" class="form-control" id="Reference" name="Reference" placeholder="e.g Siphesihle Mthunywa">
                    </div>
                   <div class="form-group">
...
<option>1999</option>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="To" name="To" placeholder="AMA123">
                    </div>
    
                    <div class="form-group">
                      <label for="exampleInputUsername1">Reference</label>
                      <input type="text" class="form-control" id="Reference2" name="Reference2" placeholder="e.g Siphesihle Mthunywa">
                    </div>
                    <div class="form-group">
                         <label for="month">Transaction method</label>
                        <select class="form-control" id="cashTrans" name="cashTrans">
                           <option>Select Transaction Method</option>
                          <option>Cash</option>
                           <option>Credit</option>
                          <option>Other</option>
   ...
   <form>
    <div style="text-align: center;">
        <button  type="submit" id='sub' class="btn btn-primary mr-2" name="save_cash">Submit</button>
