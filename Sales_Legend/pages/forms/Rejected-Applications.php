...
$sql = "SELECT Customer, Policy FROM incoming_rejected LIMIT $offset, $perPage";
$result = $conn->query($sql);

// Fetch all rows to calculate total count for pagination
$sqlCount = "SELECT COUNT(*) as count FROM incoming_rejected";
...
<head>
  ...
  <title>Funeral Demo Service | Rejected-Applications</title>
  <!-- plugins:css -->
...
<body>
  <div class="container-scroller">
    ...
    <span class="marquee-text">Rejected Clients</span>
  </div>
            </h3>
