...
$sql = "SELECT Customer, Policy FROM incoming_approved LIMIT $offset, $perPage";
$result = $conn->query($sql);

// Fetch all rows to calculate total count for pagination
$sqlCount = "SELECT COUNT(*) as count FROM incoming_approved";
...
<head>
  ...
  <title>Funeral Demo Service | Approved-Applications</title>
  <!-- plugins:css -->
...
<body>
  <div class="container-scroller">
    ...
    <span class="marquee-text">Approved Clients</span>
  </div>
            </h3>
