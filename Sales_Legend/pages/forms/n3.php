...
if (isset($_POST['names']) && isset($_POST['Surname'])) {
    ...
    // Handle the case where the values are not received properly
...
try{
  ...
  $save_extended = $conn1->prepare("INSERT INTO incoming_beneficiaries(Policy_number, Name, surname, _ID, Gender, Relationship, ContactNo, Nationality)
